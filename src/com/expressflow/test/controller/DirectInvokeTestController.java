...
@Controller
@RequestMapping("/test/directinvoke")
public class DirectInvokeTestController {
	
	private static Logger log = Logger.getLogger(DirectInvokeTestController.class.getSimpleName());
	...
	public DirectInvoke directInvokeTestCase() throws Exception {
		...
		activity.persist();
		log.info("DirectInvoke activity " + activity.getName() + " persisted.");
		return activity;
	}
}
