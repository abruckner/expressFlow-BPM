...
public class MobileHumanTaskListManagementServlet extends HttpServlet {
	private static final Logger log = Logger
			.getLogger(MobileHumanTaskListManagementServlet.class.getName());
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (user != null) {
			...
			String taskName = sb.substring(21, sb.length());

			if (taskName != null) {
				out.println("<html>");
				out.println("<head>");
				out.println("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">");
				out.println("<title>expressFlow - Mobile Human Task List</title>");
				...
				out.println("<script type=\"text/javascript\" src=\"/js/mobilehumantasklist.js?mobiletasklistname="
						+ taskName + "\"></script>");
